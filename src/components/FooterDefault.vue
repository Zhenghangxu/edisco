...
<template>
  <div :class="containerClass">
    <div class="card pt-16 md:pt-[8rem] px-6 md:px-8 pb-8 grid grid-cols-2 md:grid-cols-3">
      <div class="card col-span-2 md:col-span-1 flex flex-col items-center md:items-start">
        <div class="flex items-center justify-start">
          <iconContainer> <BrandLogo /> </iconContainer>
        </div>
        <div class="flex items-center justify-start text-gray-600 text-base">
          <p>{{ tagline }}</p>
        </div>
        <div class="flex flex-row gap-7 mt-8">
